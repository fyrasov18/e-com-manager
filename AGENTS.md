...
### InstaDelivery API
- **Tracking endpoint**: `GET /API/tracking/{barcode}` (barcode only, NO login/password in URL)
...
**The tracking URL must be**: `https://app.insta-delivery.com/API/tracking/{barcode}` (NOT `/tracking/{login}/{password}/{barcode}`).
